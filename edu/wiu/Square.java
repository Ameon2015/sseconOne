...
public class Square extends AbstractDrawingObject{
   private double r;
   
   // constructor 
   public Square( double x0, double y0, double r0, Color c0 ){
      super( x0, y0, c0);
      checkRadius( r0 );
      r = r0;
   }
   ...
   private void checkRadius( double r ){
      if( r <= 0 )
         throw new IllegalArgumentException( "Square cannot have negative radius." );   
   }
   ...
   public  void draw(){
      ...
      // draw it
      StdDraw.filledSquare( getX(), getY(), r );
